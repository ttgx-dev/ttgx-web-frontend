...
description: A new Minnesota based tabletop and boardgame convention
date: 2026-09-01
draft: false
toc: false
type: blog
...
The Twin Cities Tabletop Games Expo (TTGX for short) is a new expo style event coming to Brooklyn Center Minnesota April 16-18, 2027. The event is a 3 day paid event featuring: 
- Exhibit hall primarily filled with Minnesota and midwest boardgame publishers
- Free play game library with over 2000 boardgames
- Scheduled events for TTRPGS, learn to plays, and more!

This first blog post aims to give a little bit of background on the event, and where it came from.
...
## What About The Big Cons?

There are tons of boardgame events around the world: [Gen Con](https://www.gencon.com/), [GAMA](https://www.gama.org/page/gama-expo), [Spiel Essen](https://www.spiel-essen.de/en/), [Pax Unplugged](https://unplugged.paxsite.com/en-us.html), [UK Games Expo](https://www.ukgamesexpo.co.uk/), just to name a few.

One key characteristic they all share however, is that they're nowhere near Minnesota, and I'll come back to why that's important in a minute.

These events are all fantastic and have been staples of the boardgame scene for many years, while we hope to one day stand on equal footing with them, we are a long way off; so why should someone come to TTGX when these big events exist?
...
While one reason is pure bias, we are from Minnesota, there is another major reason Minnesota is a great place for a tabletop boardgame event.
...
Minnesota is a hot-spot for boardgame design, and TTGX aims to put a spotlight on it.

## Closing Remarks

We hope you've enjoyed learning a little about why we are so excited to bring TTGX to Minnesota. Lets us know on our [Discord](https://discord.gg/uEZ8jdZC5v) what you thought of the blog, and what you'd like to see next!